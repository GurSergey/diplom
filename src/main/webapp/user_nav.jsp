...
<nav>
    <div class="nav-wrapper blue darken-4">
        <a href="${fn:substring(url, 0, fn:length(url) - fn:length(uri))}${req.contextPath}/user/" class="brand-logo " style="margin-left: 20px">ML</a>
...
<%--            <li><a href="${fn:substring(url, 0, fn:length(url) - fn:length(uri))}${req.contextPath}/user_auth">Авторизоваться</a></li>--%>
            ...
            <li><a href="${fn:substring(url, 0, fn:length(url) - fn:length(uri))}${req.contextPath}/user/tasks/">Список текстовых задач</a></li>
